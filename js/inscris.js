...
function btnpres(){
 ...
 function btnsuivant(){
  ...
  var  telephone = document.getElementById("Telephone"),affichTel=document.getElementById("affich7");
  var  adresse = document.getElementById("Adresse"),affichAdresse=document.getElementById("affich8");
  var regEmail=/\w+@\w+\.(net|com|fr)/;
  var regPrenom=/[A-Z]{5,10}/;
  var regPrenom=/\w{5,10}/;
var regpass=/(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[@!=])[a-zA-Z0-9@!=]{8,}/;
var regAdresse=/[a-zA-Z0-9 ]{10,}/;
...
if(prenom.value==="" ||  nom.value==="" || cin.value==="" || telephone.value==="" || adresse.value==="" || email.value==="" || password.value==="" || confirmationPS.value===""){
